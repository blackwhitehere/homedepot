...
feat_folder = config.root+"/Feat/LSA_and_stats_feat_Jun09"
...
feat_folder = config.root+"/Feat/solution/LSA_and_stats_feat_Jun09"
...
#############
## regression with xgboost tree booster
feat_folder = config.root+"/Feat/solution/LSA_svd150_and_Jaccard_coef_Jun14"
...
from config import config
## regression with xgboost tree booster
feat_folder = config.root+"/Feat/svd100_and_bow_Jun23"
...
## cocr with xgboost linear booster
feat_folder = config.root+"/Feat/solution/svd100_and_bow_Jun23"
...
#############
## regression with xgboost tree booster
feat_folder = config.root+"/Feat/solution/svd100_and_bow_Jun27"
