...
class ParamConfig:
    def __init__(self,
        ...
        # path
        self.data_folder = os.getcwd() + "/input/"
        self.feat_folder = feat_folder
        self.original_train_data_path = "{}train.csv".format(self.data_folder)
        self.original_test_data_path = "{}test.csv".format(self.data_folder)
        self.processed_train_data_path = "%strain.processed.csv.pkl" % self.feat_folder
        self.processed_test_data_path = "%stest.processed.csv.pkl" % self.feat_folder
        self.pos_tagged_train_data_path = "%strain.pos_tagged.csv.pkl" % self.feat_folder
        self.pos_tagged_test_data_path = "%stest.pos_tagged.csv.pkl" % self.feat_folder
...
config = ParamConfig(feat_folder=path + "/Feat/solution/",
                     drop_html_flag=True,
                     stemmer_type="porter",
                     cooccurrence_word_exclude_stopword=False)
